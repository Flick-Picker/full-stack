...
\begin{tabularx}{\textwidth}{|X|p{4cm}|p{2cm}|p{2cm}|}
	...
	\hline
	Create Login \& Password Reset Pages & Login (Native \& Auth) & end of Jan & Talha\\
	\hline
	Integrate External APIs to backend & API & end of Jan & Madhi\\
	\hline
	Setup Firebase DB & API, DB & end of Jan & Jarrod\\
	\hline
	Create Home \& Profile Pages & Profile & end of Jan & Andrew\\
	\hline
	Create Preference Pages & Profile & end of Jan & Ali\\
	\hline
	Add native login functionality & Native Login & end of Jan & Jarrod\\
	\hline
	Add Auth functionality & Auth Login & end of Jan & Madhi\\
	\hline
	Create Groups Page & Group & end of Jan & Ali\\
	\hline
	Create Friends Page & Friend & end of Jan & Andrew\\
	\hline
	Create Recommendation Pages & Friend & end of Jan & Talha\\
	\hline
	Hookup Backend to Frontend & All & Feb 10 & Talha, Jarrod\\
	\hline
