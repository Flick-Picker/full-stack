...
The following document details the Module Interface Specifications for Flick Picker. Flick Picker is a web application that allows people to select their preferences in regarding watchable media genres and find recommendations of things to watch based on those preferences, being able to take multiple sets of preferences into account to find new media. Users can find new things to watch by themselves using only their preferences, or join user groups that find media based on the preferences of everyone in the group.
